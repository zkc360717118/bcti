    ...
    <script>
		$(function(){
			...
			$('.addDay').click(function(){
				...
				oDay.children('label').html('地点'+arr[numDay-1]);
...
<div class="left">
    ...
    <div class="container tour">
        ...
        <div class="col-md-12 day">
            <label class="col-md-3">地点一:</label>
            <div class="col-md-3">
        ...
        <button class="btn btn-primary btn-xs pull-right deleteDay">删除地点</button>
        <button class="btn btn-primary btn-xs pull-right addDay">增加地点</button>
    </div>
    <hr class="mbm"/>
    ...
    <div class="container hotelF">
        ...
        <button id="deleteHotelBtn" style="display: none;" class="btn btn-primary btn-xs pull-right dltHotel">删除一个酒店选择</button>
        <button id="addHotelBtn" style="display: none;" class="btn btn-primary btn-xs pull-right addHotel">增加一个酒店选择</button>
    </div>
    <hr class="divider"/>
    <div class="container">
        <div class="col-md-12">
...
<div class="right">
    <form class="form-horizontal" role="form" action="/maketourhaveiti" method="post">
        {{csrf_field()}}
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div>
                    ...
                    <textarea name="content" id="" cols="120" rows="35"></textarea>
                </div>
