...
<form class="form-horizontal" role="form" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea name="contents" id="" cols="130" rows="10" >{{$p->content}}</textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" name="city" class="form-control" list="citylist" value="{{$p->city}}">
    ...
    <div class="form-group">
        <div class="col-sm-offset-4 col-sm-8">
            <input type="hidden" name="itid" value="{{$p->itid}}">
